        ...
        <div>
          {update ? (
            <div className="text-lg font-medium space-y-2">
              <h1>
                Name: <span className="text-success">{user?.displayName}</span>
              </h1>
              <h1>
                Email:{" "}
                <span className="text-error break-all">{user?.email}</span>
              </h1>
              <h1 className="">
                Photo Url:{" "}
                <span className="text-primary break-all text-base">
                  {user?.photoURL}
                </span>
              </h1>
            </div>
            ...
            <div className="space-y-3 mt-4">
              <input
                ...
                className="bg-cyan-100 p-2 rounded-md w-full outline-none text-primary text-base"
                type="text"
