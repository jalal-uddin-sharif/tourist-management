  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <div className="text-teal-600 flex items-center text-2xl font-medium">
            <img className="h-10" src={logoImg} alt="" />
            <h1>TourSpotter</h1>
          </div>
  
          <p className="mt-4 max-w-xs text-gray-500">
            Explore our tourist spots. Make your best Chooice
          </p>
      ...
      <p className="text-xs text-gray-500">&copy; 2024. GuestWe. All rights reserved.</p>
    </div>
  </footer>
  );
};
