  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {
          spotData.map(spot =>(
            <div key={spot._id} className="card bg-base-100 shadow-xl border image-full">
          <figure>
            <img
              src={spot.image}
              alt="loading"
          ...
          <div className="card-body">
            ...
            <h1 className="flex  gap-1">
                  ...
                  <h1 className='flex gap-2'> <MdOutlineModeOfTravel   className='mt-' color='#1B96EE' size={20} /> 
                    Travel time: {spot.travel_time}</h1>
            <div className="card-actions justify-end mt-auto">
              <Link to={`/spots/${spot._id}`} className="btn btn-primary w-full  btn-sm">View Details</Link>
            </div>
          </div>
        </div>
          ))
